...
Version  : 0.2.17
Release  : 64
URL      : https://cran.r-project.org/src/contrib/topicmodels_0.2-17.tar.gz
Source0  : https://cran.r-project.org/src/contrib/topicmodels_0.2-17.tar.gz
...
pushd ..
cp -a topicmodels buildavx2
popd
pushd ..
cp -a topicmodels buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723644917
...
/usr/lib64/R/library/topicmodels/data/JSS_papers.rda
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/topicmodels/libs/topicmodels.so
/V4/usr/lib64/R/library/topicmodels/libs/topicmodels.so
